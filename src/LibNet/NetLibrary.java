...
public static PetriNet CreateNetCoursework6() throws ExceptionInvalidNetStructure, ExceptionInvalidTimeDelay {
	PetriNet d_Net = CreateNetCoursework(500);
	return d_Net;
}
public static PetriNet CreateNetCoursework(int n) throws ExceptionInvalidNetStructure, ExceptionInvalidTimeDelay {
		ArrayList<PetriP> d_P = new ArrayList<>();
		ArrayList<PetriT> d_T = new ArrayList<>();
		ArrayList<ArcIn> d_In = new ArrayList<>();
		ArrayList<ArcOut> d_Out = new ArrayList<>();
...
public static PetriNet CreateNetCoursework(int n, double shipIncomeTime, double serviceMeanTime, double serviceDeviationTime) throws ExceptionInvalidNetStructure, ExceptionInvalidTimeDelay {
		ArrayList<PetriP> d_P = new ArrayList<>();
		ArrayList<PetriT> d_T = new ArrayList<>();
		ArrayList<ArcIn> d_In = new ArrayList<>();
		ArrayList<ArcOut> d_Out = new ArrayList<>();
		...
		d_P.add(new PetriP("Crane2",1));
		d_P.add(new PetriP("P3",0));
		d_T.add(new PetriT("Ship come", shipIncomeTime));
		d_T.get(0).setDistribution("exp", d_T.get(0).getTimeServ());
		d_T.get(0).setParamDeviation(0.0);
		d_T.add(new PetriT("Start1",0.0));
		d_T.add(new PetriT("Service1",serviceMeanTime/n));
		d_T.get(2).setDistribution("unif", d_T.get(2).getTimeServ());
		d_T.get(2).setParamDeviation(serviceDeviationTime/n);
		d_T.add(new PetriT("Exit1",0.0));
		d_T.add(new PetriT("Service1 x 2", serviceMeanTime/2/n));
		d_T.get(4).setDistribution("unif", d_T.get(4).getTimeServ());
		d_T.get(4).setParamDeviation(serviceDeviationTime/2/n);
		d_T.get(4).setPriority(1);
		d_T.add(new PetriT("Start2",0.0));
		d_T.add(new PetriT("Service2",serviceMeanTime/n));
		d_T.get(6).setDistribution("unif", d_T.get(6).getTimeServ());
		d_T.get(6).setParamDeviation(serviceDeviationTime/n);
		d_T.add(new PetriT("Exit2",0.0));
		d_T.add(new PetriT("Service2 x 2",serviceMeanTime/2/n));
		d_T.get(8).setDistribution("unif", d_T.get(8).getTimeServ());
		d_T.get(8).setParamDeviation(serviceDeviationTime/2/n);
		d_T.get(8).setPriority(1);
		d_In.add(new ArcIn(d_P.get(0),d_T.get(0),1));
		d_In.add(new ArcIn(d_P.get(1),d_T.get(1),1));
		d_In.add(new ArcIn(d_P.get(2),d_T.get(1),1));
