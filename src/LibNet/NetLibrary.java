...
public static PetriNet CreateNetTask3(double fridgeCreationTime, double reorderTime, double clientComeTime, double possibilityOfClientWaiting) throws ExceptionInvalidNetStructure, ExceptionInvalidTimeDelay {
	...
	d_P.add(new PetriP("P1",1));
	d_P.add(new PetriP("P2",0));
	d_P.add(new PetriP("PlaceOrder",0));
	d_P.add(new PetriP("NeedToOrder",0));
	d_P.add(new PetriP("P6",0));
	d_P.add(new PetriP("P7",0));
	d_P.add(new PetriP("P8",0));
	...
	d_In.add(new ArcIn(d_P.get(1),d_T.get(2),1));
	d_In.add(new ArcIn(d_P.get(3),d_T.get(2),1));
	d_In.add(new ArcIn(d_P.get(3),d_T.get(3),54));
	...
	d_Out.add(new ArcOut(d_T.get(12),d_P.get(3),1));
